...
class EnterpriseMaster(models.Model):
    ...
    owner_tel_1 = models.CharField(max_length=20, null=True, verbose_name='대표자 전화번호1')
    owner_tel_2 = models.CharField(max_length=20, null=True, verbose_name='대표자 전화번호2')
    owner_tel_3 = models.CharField(max_length=20, null=True, verbose_name='대표자 전화번호3')
    ...
    address = models.CharField(max_length=128, null=True, verbose_name='기본 주소')
    address_detail = models.CharField(max_length=128, null=True, verbose_name='상세 주소')
...
class CustomerMaster(models.Model):
    ...
    business_type = models.CharField(max_length=64, null=True, verbose_name="업태")
    business_sort = models.CharField(max_length=64, null=True, verbose_name="종목")
    postal_code = models.CharField(max_length=64, null=True, verbose_name='우편번호')
